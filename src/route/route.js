...
const {createUser,userLogin,getUser,userUpdate}=require("../user/userController")
const {createProduct, getProduct, getProductByQuery, updateProduct, deletProduct}= require('../product/productController')
const {authenticate,authorize}=require('../middleware/auth');


const { createCart, updateCart,getCart,deleteCart} = require("../cart/cartController");

const {createOrder, updateOrder}= require('../order/orderController')
